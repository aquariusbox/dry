...
ReceivePortImpl: {"": "Object;_liblib11$_id<,_liblib11$_callback<",
  ...
  ReceivePortImpl$0: function() {
    $globalState.currentContext.register$2(this._liblib11$_id, this);
  },
  $isReceivePort: true,
  static: {
...
allMatchesInStringUnchecked: function(needle, haystack) {
  ...
  for (startIndex = 0; true;) {
    ...
    if ($.$eq(endIndex, $length) === true)
      break;
    else if (t1.$eq(position, endIndex) === true) {
      if (typeof startIndex !== "number")
...
ScriptElement: {"": "_HTMLElement;event=,type%"},
...
_ListRange: {"": "IterableBase;_liblib8$_source,_offset,_liblib8$_length",
  get$iterator: function(_) {
    var t1, t2, t3;
...
_ListRangeIteratorImpl: {"": "Object;_liblib8$_source,_offset,_liblib8$_end",
  get$current: function() {
    var t1, t2;
    t1 = this._liblib8$_source;
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !$.isJsIndexable(t1, t1[$.dispatchPropertyName])))
...
embedGoogleMap: function() {
  $.scoped(new $.embedGoogleMap_closure($.C__Random));
},

"+embedGoogleMap:0:0": 0,

randomInRange: function(from, to, fixed) {
  return $.$mul$n($.Primitives_parseDouble($.JSDouble_methods.toStringAsFixed$1(Math.random() * (to - from) + from, fixed), null), 1);
},
...
embedGoogleMap_closure: {"": "Closure;rng_0",
  call$0: function() {
    var t1, mapOptions, t2, t3;
    $._enterScopeIfNeeded();
    t1 = $._deserialize($._jsPortSync.callSync$1([])).get$Object();
    mapOptions = new $.MapOptions($.Proxy_Proxy$withArgList(t1, []));
    mapOptions.set$zoom(this.rng_0.nextInt$1(10) + 5);
    mapOptions.set$disableDoubleClickZoom(true);
    t1 = $.randomInRange(-85, 85, 3);
    t2 = $.randomInRange(-180, 180, 3);
    ...
    mapOptions.set$mapTypeId($.get$MapTypeId_TERRAIN());
    mapOptions.set$disableDefaultUI(true);
    mapOptions.set$zoomControl(false);
...
GEvent_getStreamProviderFor__closure: {"": "Closure;transformArguments_5,eventSink_6",
  call$5: function(p1, p2, p3, p4, p5) {
    ...
    if (t1 === 0)
      ...
      value = t1 === 1 ? $.JSArray_methods.get$first(args) : args;
...
MapOptions: {"": "TypedProxy;$$unsafe",
  ...
  set$disableDefaultUI: function(disableDefaultUI) {
    $.$indexSet$ax(this.$$unsafe, "disableDefaultUI", disableDefaultUI);
    return disableDefaultUI;
  },
  set$disableDoubleClickZoom: function(disableDoubleClickZoom) {
    $.$indexSet$ax(this.$$unsafe, "disableDoubleClickZoom", disableDoubleClickZoom);
  ...
  set$zoomControl: function(zoomControl) {
    $.$indexSet$ax(this.$$unsafe, "zoomControl", zoomControl);
    return zoomControl;
  }
},
