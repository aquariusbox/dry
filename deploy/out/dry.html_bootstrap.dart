import "dart:collection" as ZC;import "dart:html" as m;import "dart:async" as fB;import "dart:math" as sF;import "dart:mirrors" as KF;import "dart:isolate" as AB;class LF{static const  MF="Chrome";final  nE;final  minimumVersion;const LF(this.nE,[this.minimumVersion]);}class NF{const NF();}class OF{final  name;const OF(this.name);}class PF{const PF();}class QF{const QF();}class RF extends tC with DB{var CG;static final HD=new m.DocumentFragment.html('''
